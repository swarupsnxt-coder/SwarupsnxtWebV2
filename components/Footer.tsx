  ...
  return (
    <footer className="bg-[#0f172a] pt-24 pb-12 border-t border-white/5">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-12 mb-20">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#2BB6C6] hover:text-[#0f172a] transition-all">
          ...
          <div>
            <h4 className="text-sm font-bold uppercase tracking-widest text-white mb-6">Intelligence</h4>
            <ul className="space-y-4 text-sm text-slate-500">
              <li><a href="#" className="hover:text-[#2BB6C6] transition-colors">Neural Studio</a></li>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-[10px] uppercase tracking-[0.2em] text-slate-600">
          <p>© 2025 Swarups NXT Intelligence. All Rights Reserved.</p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <span>India Headquarters: Bangalore, KA</span>
