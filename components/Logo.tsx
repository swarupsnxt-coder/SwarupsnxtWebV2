  ...
  return (
    <div className={`flex items-center ${className || ''}`}>
      ...
      >
        ...
        <g>
          <rect fill="#3bc0cf" x="84.76" y="16.73" width="8.47" height="47.79" transform="translate(177.98 81.25) rotate(180)"/>
          <rect fill="#3bc0cf" x="33.66" y="46.67" width="8.47" height="36.41"/>
          
          <path fill="#3bc0cf" d="M92.7,58.02h-8.4s-.02,11.69-.02,11.89c0,4.59-3.72,8.31-8.31,8.31s-8.31-3.72-8.31-8.31c0-.2-.04-.63-.02-.83V31.38c0-.2,0-.78,0-.98,0-9.24-7.49-16.73-16.73-16.73s-16.73,7.49-16.73,16.73c0,.2,0,.39.02.59h-.02v12.63h8.4v-12.61h.05c-.01-.2-.03-.4-.03-.6,0-4.59,3.72-8.31,8.31-8.31s8.31,3.72,8.31,8.31c0,.2.04.78.02.98v37.7c0,.2,0,.63,0,.83,0,9.24,7.49,16.73,16.73,16.73s16.73-7.49,16.73-16.73c0-.16,0-.31-.01-.46h.01v-11.43Z"/>
          ...
          />
          <rect fill="#3bc0cf" x="59.25" y="42.47" width="8.4" height="14.33"/>
        </g>
      </svg>
    </div>
  );
