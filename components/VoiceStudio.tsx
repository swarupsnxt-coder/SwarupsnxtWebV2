...
const VoiceStudio: React.FC = () => {
  ...
  const SCRIPTS: Record<string, Record<string, string>> = {
    'Real Estate': {
      ...
      'Malayalam': "നമസ്കാരം! ലക്ഷ്വറി എസ്റ്റേറ്റ്സിൽ നിന്ന് സ്വരൂപ് ആണ്. നിങ്ങൾ ഞങ്ങളുടെ 3 BHK പ്രോപ്പർട്ടി നോക്കിയത് ശ്രദ്ധിച്ചു. ഈ ആഴ്ച സൈറ്റ് വിസിറ്റ് പ്ലാൻ ചെയ്യട്ടെയോ?",
    ...
    'EdTech': {
      ...
      'Malayalam': "ഹായ്, NXT അക്കാദമിയിൽ നിന്ന് അറ്റ്‌ലസ് ആണ്. നിങ്ങൾ AI മൊഡ്യൂൾ വിജയകരമായി അൺലോക്ക് ചെയ്തു. ആദ്യ പാഠം തുടങ്ങാൻ തയ്യാറാണോ?",
  ...
  const handleAction = async () => {
    ...
    try {
      const base64Audio = await generateSpeech(fullPrompt, voiceName);
